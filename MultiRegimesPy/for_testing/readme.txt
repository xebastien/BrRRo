MultiRegimesPy MATLAB Python Package
...
2. Installing the MultiRegimesPy Package

A. Change to the directory that contains the file setup.py and the subdirectory 
MultiRegimesPy. If you do not have write permissions, copy all its contents to a 
...
3. Using the MultiRegimesPy Package

The MultiRegimesPy package is on your Python path. To import it into a Python script or 
session, execute:

    import MultiRegimesPy
